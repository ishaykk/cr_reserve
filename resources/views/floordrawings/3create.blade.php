...
<head>
    ...
    <script src="{{ asset('js/fabricjs/fabric.js') }}" defer></script>
</head>
...
<body>
    <div class="controls">
        ...
        <ul>
            ...
            <li><img onclick="AddRect()" class="shape" id="addRect" src="img/rect_icon_20x20.png"></li>
            <li><img onclick="AddCircle()" class="shape" id="addCircle" src="img/circle_icon_20x20.png"></li>
            ...
            <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#saveJsonModal">Save JSON
                in DB</a>
                        ...
                        <div class="modal-body">
                            <form class="ml-2">
                                ...
                                <div class="form-group form-inline row m-3">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control col-12" id="description" placeholder="Enter description here... (optional)"></textarea>
                                </div>
                                <div class="modal-footer d-flex justify-content-center">
                                    <!-- <a class="btn btn-danger" href="#" id="btnSubmit">Save</a> -->
    ...
    <script>
        ...
        deleteImg.src = "svg/remove.svg"; //deleteIcon;
